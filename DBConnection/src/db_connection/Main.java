...
public class Main {
    ...
    public static void main(String[] args) {
        //Bütün productlarý getir
        //getAllProducts();

        //Product ekle
        //productInsert("Kýlýfý", "Elektronik", 80, "Telefon");
       ...
       /* Product product1 = new Product(null, "Kýlýfý", "Elektronik", 80, "Telefon");
        Product product2 = new Product(null, "Kýlýfý", "Moda", 90, "Telefon");
        Product product3 = new Product(null, "Kýlýfý", "Spor&Outdoor", 100, "Telefon");
        Product product4 = new Product(null, "Kýlýfý", "Elektronik", 110, "Telefon");
